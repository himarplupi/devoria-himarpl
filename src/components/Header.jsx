...
export default function Header() {
  ...
  return (
    <>
      <div className={`md:hidden fixed top-0 left-0 w-full h-full z-[91] transition-all duration-600 ${openSidebar ? "translate-x-0 " : "-translate-x-full"}`} onClick={() => setOpenSidebar(false)}>
        <div
          ref={sideBarRef}
